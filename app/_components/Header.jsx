        ...
        <header className="bg-white dark:bg-gray-900">
            <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="block md:hidden" onClick={handleToggleOpen}>
                    <button
                ...
                <div className='px-2 md:px-0 py-3 space-y-2 md:space-y-0 md:space-x-2 font-medium text-slate-700'>
                    <nav aria-label="Global">
                    <ul className="flex flex-col items-center gap-6 justify-center">
                        <li className='block'>
                        <Link
                            className="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75 px-3 py-2 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700"
                            href="/"
                        >
                            Home
                        </Link>
